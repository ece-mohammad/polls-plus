...
urlpatterns = [
    ...
    path("<int:poll_id>/", PollDetailView.as_view(), name="polls_details"),
    path("<int:poll_id>/vote", PollVoteView.as_view(), name="polls_vote"),
    path("<int:poll_id>/results", PollResultsView.as_view(), name="polls_result"),
